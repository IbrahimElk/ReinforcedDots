...
class StrategyAdvisor : 
    ...
    def get_available_action(self, state, 
        ...
        # 5) alle legale acties meegeven.
        # TODO: als board size > x , dan niet alle legale acties, dan sample 2 random acties hieruit!!!
    ...
    def get_lcr_actions(self, state, actions, cache_chains, maximizing_player_id):
        """
    ...
    def moveOrdening(self, state, lcr_actions, maximizing_player_id):
        ...
        Dus de lijst van acties sorteren naar de acties die eerst zorgen 
        voor het minste aantal boxes te geven aan de opponent. 
