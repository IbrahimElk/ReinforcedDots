...
@click.option('--rounds', default=10, help='Number of rounds to play.')
...
def cli(agent1_id, agent1_dir, agent2_id, agent2_dir, output, rounds, num_rows, num_cols, seed):
    ...
    results.dump_stats("report/performance/result_emd2_vs_emd3_no_points_in_tt_symmetry_disabled_eval_with_SA.prof")
