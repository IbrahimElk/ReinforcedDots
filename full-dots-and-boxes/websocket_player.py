...
Instructions:
- start agent using `./websocket_player.py agent/ 8080`
- Enter `ws://127.0.0.1:5001` as the FIRST agent in the interface
- Start playing

Localtunnel is also possible if installed with 
npm -g install localtunnel
uncomment the necessary code as well.

Created by Wannes Meert 
Contributor Ibrahim El Kaddouri
