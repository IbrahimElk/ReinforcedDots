...
An agent that can participate in a tournament.

Created by Pieter Robberechts, Wannes Meert, Ibrahim El Kaddouri
...
def get_agent_for_tournament(player_id):
    """
    this function is responsible for initializing the agent.
    This function is called by the tournament code at the 
...
class Agent(pyspiel.Bot):
    ...
    def __init__(self, player_id):
        ...
        Note: This agent makes use of a pre-trained policy to enter
        the tournament. No training is done when initialising, 
        the agent should thus take no more than a few seconds.
        """
